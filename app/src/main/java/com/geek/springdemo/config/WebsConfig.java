...
public interface WebsConfig {
    ...
    void getPieData(String userID,String type,String kind,String startTime,String endTime ,Subscriber<List<PieModel>> subscriber);
    void getLineData(String userID,String type,String kind,String startTime,String endTime ,Subscriber<List<LineModel>> subscriber);
}
