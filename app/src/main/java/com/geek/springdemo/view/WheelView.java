 ...
 * 滚动选择器帮助类
 * @author cmm
 * create at 2016年10月20日 下午1:49:06
 */
public class WheelView extends ScrollView {
    ...
    private LinearLayout views;//基本布局
    ...
    public static final int OFF_SET_DEFAULT = 1;//1
...
//            position = divided + offset + 1;
    ...
    private int scrollDirection = -1;//滚动位置
    private static final int SCROLL_DIRECTION_UP = 0;//开始
    private static final int SCROLL_DIRECTION_DOWN = 1;//停止
    ...
    private OnWheelViewListener onWheelViewListener;//本类监听
